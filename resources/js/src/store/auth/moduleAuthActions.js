...
export default {
  ...
  login ({ commit, state, dispatch }, payload) {
    ...
    // Try to sigin
    axios.post('api/login',{'email':payload.userDetails.email, 'password':payload.userDetails.password})
  ...
  registerApplicant ({dispatch}, payload) {
      ...
      jwt.login(payload.userDetails.email, payload.userDetails.password)
        .then(response => {
          ...
          if (response.data.userData) {
            ...
            // localStorage.setItem('userInfo',response.data.userData)
            // Update user details
  ...
  createApplication ({ commit }, payload) {
    ...
    const { name, country, about, skype_id,image } = payload.userDetails
    ...
    return new Promise((resolve, reject) => {
      ...
      jwt.registerUser(name, country, about, skype_id,image)
        .then(response => {
          // Redirect User
          // router.push(router.currentRoute.query.to || '/')
