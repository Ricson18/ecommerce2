    ...
    <vx-card v-if="user_data">
      ...
      <div slot="no-body" class="tabs-container px-6 pt-6">
        ...
        <vs-tabs v-model="activeTab" class="tab-action-btn-fill-conatiner">
          <vs-tab label="Edit Product" icon-pack="feather" icon="icon-user">
            <div class="tab-text">
              <product-edit-tab-account class="mt-4" :data="user_data" />
            </div>
          </vs-tab>
...
import ProductEditTabSocial      from './ProductEditTabSocial.vue'
