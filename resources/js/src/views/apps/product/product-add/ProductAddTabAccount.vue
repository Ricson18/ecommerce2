  ...
  <div id="user-edit-tab-info">
    ...
    <div class="vx-row">
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="Price" v-model="data_local.price" v-validate="'required|alpha_spaces'" name="price" />
        <span class="text-danger text-sm"  v-show="errors.has('price')">{{ errors.first('price') }}</span>

        <vs-input class="w-full mt-4" label="Quantity" v-model="data_local.quantity" v-validate="'required|alpha_spaces'" name="quantity" />
        <span class="text-danger text-sm"  v-show="errors.has('quantity')">{{ errors.first('quantity') }}</span>

        <vs-input class="w-full mt-4" label="Slug" v-model="data_local.slug" v-validate="'required|alpha_spaces'" name="slug" />
        <span class="text-danger text-sm"  v-show="errors.has('slug')">{{ errors.first('slug') }}</span>

        <vs-textarea class="w-full mt-4" label="Description" v-model="data_local.desc" v-validate="'required|alpha_spaces'" name="desc" />
