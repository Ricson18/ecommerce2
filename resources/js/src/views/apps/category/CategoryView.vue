      ...
      <vx-card title="Category" class="mb-base">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col w-full flex" id="account-manage-buttons">
            <vs-button icon-pack="feather" icon="icon-edit" class="mr-4" :to="{name: 'app-product-edit', params: { userId: $route.params.userId }}">Edit</vs-button>
...
export default {
  ...
  created () {
    ...
    const categoryId = this.$route.params.userId
    this.$store.dispatch('dataList/fetchCategoryItem', categoryId)
