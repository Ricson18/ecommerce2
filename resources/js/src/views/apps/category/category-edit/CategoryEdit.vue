    ...
    <vx-card v-if="user_data">
      ...
      <div slot="no-body" class="tabs-container px-6 pt-6">
        ...
        <vs-tabs v-model="activeTab" class="tab-action-btn-fill-conatiner">
          <vs-tab label="Edit Category" icon-pack="feather" icon="icon-user">
            <div class="tab-text">
              <category-edit-tab-account class="mt-4" :data="user_data" />
            </div>
          </vs-tab>
          <!-- <vs-tab label="Information" icon-pack="feather" icon="icon-info">
            <div class="tab-text">
              <category-edit-tab-information class="mt-4" :data="user_data" />
            </div>
          </vs-tab>
          <vs-tab label="Social" icon-pack="feather" icon="icon-share-2">
            <div class="tab-text">
              <category-edit-tab-social class="mt-4" :data="user_data" />
            </div>
          </vs-tab> -->
        </vs-tabs>
...
import CategoryEditTabSocial      from './CategoryEditTabSocial.vue'
...
export default {
  ...
  methods: {
    fetch_user_data (userId) {
      this.$store.dispatch('dataList/fetchCategoryItem', userId)
