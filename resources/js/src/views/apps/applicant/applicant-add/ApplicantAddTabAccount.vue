...
<template>
  <div id="applicant-edit-tab-info">
    ...
    <div class="vx-row">
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="Skype ID" v-model="data_local.skype_id" v-validate="'required|alpha_spaces'" name="skype_id" />
        <span class="text-danger text-sm"  v-show="errors.has('skype_id')">{{ errors.first('skype_id') }}</span>

        <!-- <vs-input class="w-full mt-4" label="About" v-model="data_local.about" v-validate="'required|alpha_spaces'" name="about" />
        <span class="text-danger text-sm"  v-show="errors.has('about')">{{ errors.first('about') }}</span> -->

        <vs-textarea class="w-full mt-4" label="About" v-model="data_local.about" v-validate="'required|alpha_spaces'" name="about" />
        <span class="text-danger text-sm"  v-show="errors.has('about')">{{ errors.first('about') }}</span>
