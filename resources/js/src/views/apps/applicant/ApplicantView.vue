...
<template>
  <div id="page-applicant-view">
    ...
    <div id="user-data" v-if="user_data">
      ...
      <vx-card title="Applicant" class="mb-base">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col flex-1" id="account-info-col-1">
            <table>
              ...
              <tr>
                <td class="font-semibold">Country of Residence</td>
          ...
          <div class="vx-col flex-1" id="account-info-col-2">
            <table>
              <tr>
                <td class="font-semibold">Skype ID</td>
                <td>{{ user_data.skype_id }}</td>
              </tr>
              <tr>
                <td class="font-semibold">About</td>
          ...
          <div class="vx-col w-full flex" id="account-manage-buttons">
            <vs-button icon-pack="feather" icon="icon-edit" class="mr-4" :to="{name: 'app-applicant-edit', params: { userId: $route.params.userId }}">Edit</vs-button>
...
export default {
  ...
  methods: {
    ...
    deleteRecord () {
      ...
      this.$store.dispatch('dataList/removeApplicant', this.user_data.id)
