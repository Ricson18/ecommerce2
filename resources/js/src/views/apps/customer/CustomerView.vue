...
<template>
  <div id="page-user-view">
    ...
    <div id="user-data" v-if="user_data">
      ...
      <vx-card title="Customer Account" class="mb-base">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col w-full flex" id="account-manage-buttons">
            <vs-button icon-pack="feather" icon="icon-edit" class="mr-4" :to="{name: 'app-customer-edit', params: { userId: $route.params.userId }}">Edit</vs-button>
      ...
      <div class="vx-row">
        <div class="vx-col lg:w-1/2 w-full">
          <vx-card title="Billing Information" class="mb-base">
            <table>
              <tr>
                <td class="font-semibold">Billing Address 1</td>
                <td>{{ user_data.billingAddress1 }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Billing Address 2</td>
                <td>{{ user_data.billingAddress2 }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Postal Code</td>
                <td>{{ user_data.billingPostalCode }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Billing Email</td>
                <td>{{ user_data.billingEmail }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Billing City</td>
                <td>{{ user_data.billingCity }}</td>
              </tr><tr>
                <td class="font-semibold">Billing Country</td>
                <td>{{ user_data.billingCountry }}</td>
              </tr>
...
export default {
  ...
  methods: {
    ...
    deleteRecord () {
      ...
      this.$router.push({name:'app-coustomer-list'})
  ...
  created () {
    ...
    const customerId = this.$route.params.userId
    this.$store.dispatch('dataList/fetchCustomerItem', customerId)
