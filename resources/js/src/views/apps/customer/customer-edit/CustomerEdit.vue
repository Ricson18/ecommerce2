    ...
    <vx-card v-if="user_data">
      ...
      <div slot="no-body" class="tabs-container px-6 pt-6">
        ...
        <vs-tabs v-model="activeTab" class="tab-action-btn-fill-conatiner">
          <vs-tab label="Edit Account" icon-pack="feather" icon="icon-user">
            <div class="tab-text">
          ...
          <!-- <vs-tab label="Social" icon-pack="feather" icon="icon-share-2">
            <div class="tab-text">
              <customer-edit-tab-social class="mt-4" :data="user_data" />
            </div>
          </vs-tab> -->
        </vs-tabs>
...
export default {
  ...
  methods: {
    fetch_user_data (userId) {
      this.$store.dispatch('dataList/fetchCustomerItem', userId)
