    ...
    <div class="vx-row">
      <div class="vx-col w-full md:w-1/2">
        ...
        <div class="flex items-end">
          ...
          <span class="leading-none font-medium">Billing Information</span>
        </div>
      ...
      <div class="vx-col w-full md:w-1/2">
          ...
          <!-- Col Content -->
          <div>
            <vs-input class="w-full mt-4" label="Address Line 1" v-model="data_local.address1" v-validate="'required'" name="addd_line_1" />
            ...
            <vs-input class="w-full mt-4" label="Post Code" v-model="data_local.postalCode" v-validate="'required|numeric'" name="post_code" />
