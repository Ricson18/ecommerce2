  ...
  <div id="user-edit-tab-info">
    ...
    <div class="vx-row">
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="Phone" v-model="data_local.phone" v-validate="'required|alpha_num'" name="phone" />
        <span class="text-danger text-sm"  v-show="errors.has('phone')">{{ errors.first('phone') }}</span>

        <vs-input class="w-full mt-4" label="Address 1" v-model="data_local.address1" v-validate="'required|alpha_num'" name="address1" />
        <span class="text-danger text-sm"  v-show="errors.has('address1')">{{ errors.first('address1') }}</span>
        
        <vs-input class="w-full mt-4" label="Address 2" v-model="data_local.address2" v-validate="'required|alpha_num'" name="address2" />
        ...
        <!-- <vs-input class="w-full mt-4" label="state" v-model="data_local.username" v-validate="'required|alpha_num'" name="state" />
      ...
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="City" v-model="data_local.city" v-validate="'required|alpha_num'" name="city" />
        <span class="text-danger text-sm"  v-show="errors.has('city')">{{ errors.first('city') }}</span>

        <vs-input class="w-full mt-4" label="State" v-model="data_local.state" v-validate="'required|alpha_num'" name="state" />
        <span class="text-danger text-sm"  v-show="errors.has('state')">{{ errors.first('state') }}</span>
        
        <vs-input class="w-full mt-4" label="Country" v-model="data_local.country" v-validate="'required|alpha_num'" name="country" />
