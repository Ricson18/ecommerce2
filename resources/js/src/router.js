  ...
  routes: [
    ...
    // =============================================================================
      ...
      children: [
        ...
        {
          path: '/dashboard',
          redirect: '/apps/applicant/applicant-list'
        //   redirect: '/dashboard/analytics'
        },
        {
       ...
       {
          path: '/apps/applicant/applicant-edit/:userId',
          name: 'app-applicant-edit',
          component: () => import('@/views/apps/applicant/applicant-edit/ApplicantEdit.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Applicant' },
            ...
            pageTitle: 'Applicant Edit',
            rule: 'editor'
          }
        },
        {
          path: '/apps/applicant/applicant-add',
          // path: '/apps/product/product-add/:userId',
          name: 'app-applicant-add',
          component: () => import('@/views/apps/applicant/applicant-add/ApplicantAdd.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Applicant' },
            ...
            pageTitle: 'Applicant Add',
            rule: 'editor'
          }
        },
        {
          path: '/apps/applicant/applicant-view/:userId',
          name: 'app-applicant-view',
          component: () => import('@/views/apps/applicant/ApplicantView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Applicant' },
        ...
        {
          path: '/apps/applicant/applicant-list',
          name: 'app-applicant-list',
          component: () => import('@/views/apps/applicant/ApplicantListView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Applicant' },
