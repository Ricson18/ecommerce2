...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    save_changes: function save_changes() {
      ...
      this.data_local.status = 'Active'; // Here will go your API call for updating data
      ...
      _axios_js__WEBPACK_IMPORTED_MODULE_2__["default"].put('/api/user-management/users/' + this.data_local.id, payload.userDetails) //   axios.put('api/user-management/users/'+this.data_local.id,payload.userDetails)
...
/* harmony import */ var _axios_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/axios.js */ "./resources/js/src/axios.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    save_changes: function save_changes() {
      ...
      _axios_js__WEBPACK_IMPORTED_MODULE_5__["default"].put('/api/user-management/users/' + this.data_local.id, payload.userDetails).then(function (result) {
        payload.notify({
          ...
          _c(
            ...
            [
              _c(
                ...
                [_vm._v(_vm._s(_vm.data.fname) + " " + _vm._s(_vm.data.lname))]
              ),
              _vm._v(" "),
              _c("input", {
