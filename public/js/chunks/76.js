...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _views_components_vuesax_upload_UploadDefault_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/views/components/vuesax/upload/UploadDefault.vue */ "./resources/js/src/views/components/vuesax/upload/UploadDefault.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    validateForm: function validateForm() {
      return !this.errors.any() && this.name !== '' && this.country !== '' && this.skype_id !== '' && this.about !== ''; //    && this.isTermsConditionAccepted === true
    },
  ...
  methods: {
    ...
    registerUserJWt: function registerUserJWt() {
      ...
      if (!this.validateForm) return; //   if (!this.validateForm || !this.checkLogin()) return
      ...
      this.$store.dispatch('dataList/addApplicant', payload); // .then(res => { 
      //     alert()
  ...
  components: {
    UploadDefault: _views_components_vuesax_upload_UploadDefault_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
});
                      ...
                      _c(
                        ...
                        [
                          _c("div", { staticClass: "vx-card__title mb-4" }, [
                            ...
                            _c("p", [
                              _vm._v(
                                "Fill the below form to create a new application."
                              )
                            ])
                          ]),
                          _vm._v(" "),
